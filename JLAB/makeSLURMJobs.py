...
#            slurmFile.write("#SBATCH --time=10:00:00\n")
...
#            slurmFile.write("#SBATCH --chdir=/scratch/" + getpass.getuser() + "/slurm" + "\n")
            slurmFile.write("#SBATCH --chdir=/scratch/slurm" + "\n")
            slurmFile.write("#\n")
            slurmFile.write("\n")
...
#            slurmFile.write("eval `/usr/bin/modulecmd bash load /apps/modulefiles/singularity/3.4.0`\n")
            ...
            slurmFile.write("#  module load /apps/modulefiles/singularity/3.9.2\n")
            slurmFile.write("eval `/usr/bin/modulecmd bash load /apps/modulefiles/singularity/3.9.2`\n")
...
#            slurmFile.write("cd workdir_${SLURM_JOBID}\n")
            ...
            slurmFile.write("# Enter work directory\n")
            slurmFile.write("cd ${SLURM_JOBID}\n")
